...
//    }
    ...
    public static int[] uniqueElements(int [] a1, int [] a2) {
        //while using array we cannot allocate size dynamically. That's why I needed to integrate though array twice
        // first to get the size of final array, and then to actually rewrite the values
...
// I understand that the number of columns means how we want to present the array(in how many columns)
    ...
    //to make my life easier with normal printing
